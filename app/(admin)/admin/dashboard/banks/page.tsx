...
function Page() {
    ...
    return (
        <>
            <section id="Bank-section" className="mt-10">
                <div className="container">
                    ...
                    <div className="w-full p-6 bg-white rounded border border-gray-200 mt-6 text-[14px]">
                        <div className="flex justify-end">
                            <button onClick={() => setOpenCreateBankModal(true)}
                                                    ...
                                                    <div
                                                        ...
                                                        {options.map((option, index) => (
                                                            <li
                                                                ...
                                                                className="px-4 py-2 text-[12px] text-black hover:bg-primary hover:text-white cursor-pointer transition-Banks"
                                                            >
                                                                {option}
                                                            </li>
                                                        ))}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-center">Bank Name</th>
                                    <th className="p-3 border border-gray-200 text-center">Branch Name</th>
                                    <th className="p-3 border border-gray-200 text-center">Balance</th>
                    ...
                    <div className="fixed inset-0 z-50 flex justify-center overflow-y-auto">
                        ...
                        <div
                            ...
                            <div className="px-6 py-4 border-b border-gray-200 flex-shrink-0">
                                ...
                                <h3 className="text-[16px] font-semibold">Create Bank.</h3>
                            </div>
                                    ...
                                    <div className="input_box mt-4 block md:flex items-center gap-4">
                                        <div className="w-full">
                                            <label className="flex items-center gap-2 cursor-pointer select-none">
                                                ...
                                                <span>Is CC Loan Applicable?</span>
                                            </label>
                                        </div>
                                        <div className="w-full mt-4 md:mt-0">
                                            <label className="block mb-1 text-[14px] font-medium">
                            ...
                            <div className="px-6 py-4 border-t border-gray-200 flex-shrink-0">
                                <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                    <button onClick={() => setOpenCreateBankModal(false)}
                ...
                {openEditBankModal && (
                    <div className="fixed inset-0 z-50 flex justify-center overflow-y-auto">
                        <div className="absolute inset-0 bg-modal-opacity"
                             onClick={() => setOpenEditBankModal(false)}/>
                        <div
                            className="relative bg-white rounded shadow w-full max-w-6xl mt-10 mb-10 max-h-[90vh] flex flex-col z-10 text-[14px]">
                            {/* Modal Header - Fixed */}
                            <div className="px-6 py-4 border-b border-gray-200 flex-shrink-0">
                                ...
                                <h3 className="text-[16px] font-semibold">Edit Bank.</h3>
                            </div>
                            ...
                            <div className="px-6 py-4 border-t border-gray-200 flex-shrink-0">
                                <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                    <button onClick={() => setOpenEditBankModal(false)}
                                            className="px-4 py-2 cursor-pointer rounded bg-red-500 text-white hover:bg-red-700 transition">
                                        Cancel
                                    </button>
                                    <button onClick={() => setOpenEditBankModal(false)}
                ...
                {openDeleteBankModal && (
                    <div
                        ...
                        onClick={() => setOpenDeleteBankModal(false)}
                    >
                        <div
                        ...
                        >
                            ...
                            <div className="body_text py-4 border-b border-t border-gray-200">
                                <p className="text-gray-500 text-[14px]">
                                    You are going to delete this Bank.<br/>
