                    ...
                    <div className="w-full p-6 bg-white rounded border border-gray-200 mt-6 text-[14px]">
                        ...
                        <div className="block md:flex items-center justify-between">
                            <div className="block md:flex items-center gap-4">
                                ...
                                <div className="mt-4 md:mt-0 input_box flex items-center gap-2">
                                    <div className="w-full">
                                        <input
                                            type="text"
                            ...
                            <Link href='/admin/dashboard/customers/create'
                                                    ...
                                                    <div
                                                        ...
                                                        {options.map((option, index) => (
                                                            <li
                                                                ...
                                                                className="px-4 py-2 text-[12px] text-black hover:bg-primary hover:text-white cursor-pointer transition-customers"
                                                            >
                                                                {option}
                                                            </li>
                                                        ))}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">DMS Code</th>
                                    <th className="p-3 border border-gray-200 text-left">Full Name</th>
                                    <th className="p-3 border border-gray-200 text-left">Mobile No.</th>
                                    <th className="p-3 border border-gray-200 text-left">Address</th>
                                    <th className="p-3 border border-gray-200 text-left">Customer Type</th>
                                    <th className="p-3 border border-gray-200 text-left">Total Due</th>
                                    <th className="p-3 border border-gray-200 text-left">Details</th>
                                    ...
                                    <tr key={item.id} className="border border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 border border-gray-200">
                                            <div className="flex justify-center gap-2">
                                                <Link href='/admin/dashboard/customers/edit'
                        ...
                        >
                            ...
                            <div className="body_text py-4 border-b border-t border-gray-200">
                                <p className="text-gray-500 text-[14px]">
                                    You are going to delete this Customer.<br/>
