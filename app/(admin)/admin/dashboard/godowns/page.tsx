                                                    ...
                                                    <div
                                                        ...
                                                        {options.map((option, index) => (
                                                            <li
                                                                ...
                                                                className="px-4 py-2 text-[12px] text-black hover:bg-primary hover:text-white cursor-pointer transition-Godowns"
                                                            >
                                                                {option}
                                                            </li>
                                                        ))}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">Godown Code</th>
                ...
                {openCreateGodownModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        <div className="relative bg-white rounded shadow w-2xl mx-4 px-6 py-4 z-10 text-[14px]">
                            ...
                            <h3 className="text-[16px] font-semibold mb-4">Create New Godown</h3>
                ...
                {openEditGodownModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        <div className="relative bg-white rounded shadow w-2xl mx-4 px-6 py-4 z-10 text-[14px]">
                            ...
                            <h3 className="text-[16px] font-semibold mb-4">Edit Godown</h3>
                            <div className="py-4 border-b border-t border-gray-200">
                                <form action="" method="">
                                    <div className="input_box mt-4 block md:flex items-center gap-4">
                                        <div className="w-full mt-4 md:mt-0">
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenEditGodownModal(false)}
                                        className="px-4 py-2 cursor-pointer rounded bg-red-500 text-white hover:bg-red-700 transition">
                                    Cancel
                                </button>
                                <button onClick={() => setOpenEditGodownModal(false)}
                        ...
                        >
                            ...
                            <div className="body_text py-4 border-b border-t border-gray-200">
                                <p className="text-gray-500 text-[14px]">
                                    You are going to delete this Godown.<br/>
