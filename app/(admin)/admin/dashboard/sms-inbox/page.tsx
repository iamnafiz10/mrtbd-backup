                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">NoOfSMS</th>
                                    <th className="p-3 border border-gray-200 text-left">CustomerCode</th>
                                    <th className="p-3 border border-gray-200 text-left">CustomerName</th>
                                    <th className="p-3 border border-gray-200 text-left">SMS</th>
                                </tr>
                                </thead>
                                <tbody>
