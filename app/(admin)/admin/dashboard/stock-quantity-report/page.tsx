...
function Page() {
    ...
    // -------- CWS Modal ---------- //
    const [openCWSModal, setOpenCWSModal] = useState(false);
    useEffect(() => {
        if (openCWSModal) {
            document.body.style.position = "fixed";
            document.body.style.width = "100%";
    ...
    // -------- GWS Modal ---------- //
    const [openGWSModal, setOpenGWSModal] = useState(false);
    useEffect(() => {
        if (openGWSModal) {
            document.body.style.position = "fixed";
            document.body.style.width = "100%";
    ...
    // -------- PCWS Modal ---------- //
    const [openPCWSModal, setOpenPCWSModal] = useState(false);
    useEffect(() => {
        if (openPCWSModal) {
            document.body.style.position = "fixed";
            document.body.style.width = "100%";
        ...
        <>
            <section id="category-section" className="mt-10">
                            ...
                            <div className="col">
                                <form className="border border-gray-300 rounded p-4">
                                    ...
                                    <div className="input_box mt-4 flex items-center gap-4">
                                            ...
                                            <div className="mb-4 flex items-center justify-between text-[14px]">
                                                <label className="flex items-center gap-2 cursor-pointer select-none">
                                                    <input
                                                        type="checkbox"
                                                        className="hidden"
                                                        checked={checkboxSelected === "cws"}
                                                        onChange={() => setCheckboxSelected("cws")}
                                                    />
                                                    <div
                                                        className={`w-4 h-4 border rounded flex items-center justify-center 
                                                        ${checkboxSelected === "cws" ? "bg-primary border-primary" : "border-gray-300"}`}
                                                    >
                                                        {checkboxSelected === "cws" &&
                                                            <FaCheck className="text-white text-[10px]"/>}
                                                    </div>
                                                    <span>Company Wise Stock</span>
                                                </label>
                                            </div>
                                            <input
                                                type="text"
                                        ...
                                        <div className="mt-4">
                                            <div onClick={() => setOpenCWSModal(true)}
                                                 className="icon_box flex items-center gap-1 bg-primary p-1 text-white rounded cursor-pointer">
                                                <FiPlusSquare size={20}/>
                                                Pick
                                            </div>
                                    ...
                                    <div className="input_box mt-4 flex items-center gap-4">
                                            ...
                                            <div className="mb-4 flex items-center justify-between text-[14px]">
                                                <label className="flex items-center gap-2 cursor-pointer select-none">
                                                    <input
                                                        type="checkbox"
                                                        className="hidden"
                                                        checked={checkboxSelected === "gws"}
                                                        onChange={() => setCheckboxSelected("gws")}
                                                    />
                                                    <div
                                                        className={`w-4 h-4 border rounded flex items-center justify-center 
                                                        ${checkboxSelected === "gws" ? "bg-primary border-primary" : "border-gray-300"}`}
                                                    >
                                                        {checkboxSelected === "gws" &&
                                                            <FaCheck className="text-white text-[10px]"/>}
                                                    </div>
                                                    <span>Godown Wise Stock</span>
                                                </label>
                                            </div>
                                            <input
                                                type="text"
                                        ...
                                        <div className="mt-4">
                                            <div onClick={() => setOpenGWSModal(true)}
                                                 className="icon_box flex items-center gap-1 bg-primary p-1 text-white rounded cursor-pointer">
                                                <FiPlusSquare size={20}/>
                                                Pick
                                            </div>
                                    ...
                                    <div className="input_box mt-4 flex items-center gap-4">
                                            ...
                                            <div className="mb-4 flex items-center justify-between text-[14px]">
                                                <label className="flex items-center gap-2 cursor-pointer select-none">
                                                    <input
                                                        type="checkbox"
                                                        className="hidden"
                                                        checked={checkboxSelected === "ptws"}
                                                        onChange={() => setCheckboxSelected("ptws")}
                                                    />
                                                    <div
                                                        className={`w-4 h-4 border rounded flex items-center justify-center 
                                                        ${checkboxSelected === "ptws" ? "bg-primary border-primary" : "border-gray-300"}`}
                                                    >
                                                        {checkboxSelected === "ptws" &&
                                                            <FaCheck className="text-white text-[10px]"/>}
                                                    </div>
                                                    <span>Parent Category Wise Stock</span>
                                                </label>
                                            </div>
                                            <input
                                                type="text"
                                        ...
                                        <div className="mt-4">
                                            <div onClick={() => setOpenPCWSModal(true)}
                                                 className="icon_box flex items-center gap-1 bg-primary p-1 text-white rounded cursor-pointer">
                                                <FiPlusSquare size={20}/>
                                                Pick
                                            </div>
                ...
                {openCWSModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        <div
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenCWSModal(false)}
                                        className="px-4 py-2 cursor-pointer rounded bg-red-500 text-white hover:bg-red-700 transition">
                                    Close
                                </button>
                            </div>
                ...
                {openGWSModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        <div
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenGWSModal(false)}
                                        className="px-4 py-2 cursor-pointer rounded bg-red-500 text-white hover:bg-red-700 transition">
                                    Close
                                </button>
                            </div>
                ...
                {openPCWSModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="absolute inset-0 bg-modal-opacity"
                             onClick={() => setOpenPCWSModal(false)}/>
                        <div
                            className="w-[90%] max-w-5xl relative bg-white rounded shadow mx-4 px-4 py-4 z-10 text-[14px]">
                            <button className="absolute top-6 right-6 cursor-pointer text-gray-500 hover:text-red-500"
                                    onClick={() => setOpenPCWSModal(false)}>
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenPCWSModal(false)}
                                        className="px-4 py-2 cursor-pointer rounded bg-red-500 text-white hover:bg-red-700 transition">
                                    Close
                                </button>
                            </div>
