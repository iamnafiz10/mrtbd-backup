...
function Page() {
    ...
    // -------- SRPick Modal ---------- //
    const [openSRPickModal, setOpenSRPickModal] = useState(false);
    useEffect(() => {
        if (openSRPickModal) {
            ...
            <section id="category-section" className="mt-10">
                <div className="container">
                    <div
                        ...
                        <h2>SR Wise Installment Collection Report</h2>
                    </div>
                            ...
                            <div className="col">
                                <form className="border border-gray-300 rounded p-4">
                                    <div className="input_box flex items-center gap-2">
                                        ...
                                        <div className="mt-4">
                                            <div onClick={() => setOpenSRPickModal(true)}
                ...
                {openSRPickModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="absolute inset-0 bg-modal-opacity"
                             onClick={() => setOpenSRPickModal(false)}/>
                        <div
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenSRPickModal(false)}
