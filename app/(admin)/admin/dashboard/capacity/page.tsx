...
function Page() {
    ...
    // ---------- CREATE / Edit / Delete Capacity ---------- //
    const [openCreateCapacityModal, setOpenCreateCapacityModal] = useState(false);
    const [openEditCapacityModal, setOpenEditCapacityModal] = useState(false);
    const [openDeleteCapacityModal, setOpenDeleteCapacityModal] = useState(false);
    const handleCapacityDelete = () => {
        toast.success('Capacity deleted successfully!');
        setOpenDeleteCapacityModal(false);
    };

    return (
        <>
            <section id="Capacity-section" className="mt-10">
                <div className="container">
                    <div
                        className="page_header bg-gray-100 border border-gray-200 py-3 px-4 rounded font-semibold text-[16px]">
                        <h2>Existing Capacitys</h2>
                    </div>
                    <div className="w-full p-6 bg-white rounded border border-gray-200 mt-6 text-[14px]">
                        <div className="flex justify-end">
                            <button onClick={() => setOpenCreateCapacityModal(true)}
                                    className="flex items-center gap-1 py-2 px-4 bg-primary hover:bg-dark-primary text-white rounded text-[13px] cursor-pointer">
                                <FaPlus/> Create Capacity
                            </button>
                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        {options.map((option, index) => (
                                                            <li
                                                                ...
                                                                className="px-4 py-2 text-[12px] text-black hover:bg-primary hover:text-white cursor-pointer transition-Capacitys"
                                                            >
                                                                {option}
                                                            </li>
                                                        ))}
                                    ...
                                    <tr key={item.id} className="border border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 border border-gray-200">
                                            <div className="flex justify-center gap-2">
                                                <button onClick={() => setOpenEditCapacityModal(true)}
                                                        className="bg-blue-500 p-2 rounded text-white cursor-pointer hover:bg-blue-600 transition">
                                                    <FaPencil size={12}/>
                                                </button>
                                                <button onClick={() => setOpenDeleteCapacityModal(true)}
                ...
                {openCreateCapacityModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        <div className="relative bg-white rounded shadow w-2xl mx-4 px-6 py-4 z-10 text-[14px]">
                            ...
                            <h3 className="text-[16px] font-semibold mb-4">Create New Capacity</h3>
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenCreateCapacityModal(false)}
                ...
                {openEditCapacityModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="absolute inset-0 bg-modal-opacity"
                             onClick={() => setOpenEditCapacityModal(false)}/>
                        <div className="relative bg-white rounded shadow w-2xl mx-4 px-6 py-4 z-10 text-[14px]">
                            <button className="absolute top-6 right-6 cursor-pointer text-gray-500 hover:text-red-500"
                                    onClick={() => setOpenEditCapacityModal(false)}>
                                <RxCross1 size={18}/>
                            </button>
                            <h3 className="text-[16px] font-semibold mb-4">Edit Capacity</h3>
                            <div className="py-4 border-b border-t border-gray-200">
                                <form action="" method="">
                                    <div className="input_box mt-4 block md:flex items-center gap-4">
                                        <div className="w-full mt-4 md:mt-0">
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenEditCapacityModal(false)}
                                        className="px-4 py-2 cursor-pointer rounded bg-red-500 text-white hover:bg-red-700 transition">
                                    Cancel
                                </button>
                                <button onClick={() => setOpenEditCapacityModal(false)}
                ...
                {openDeleteCapacityModal && (
                    <div
                        ...
                        onClick={() => setOpenDeleteCapacityModal(false)}
                    >
                        <div
                        ...
                        >
                            ...
                            <div className="body_text py-4 border-b border-t border-gray-200">
                                <p className="text-gray-500 text-[14px]">
                                    You are going to delete this Capacity.<br/>
