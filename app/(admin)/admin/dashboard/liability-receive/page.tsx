...
import {FaCheck, FaChevronDown, FaPlus, FaTrashAlt} from "react-icons/fa";
        ...
        <>
            <section id="section" className="mt-10">
                        ...
                        <div className="block md:flex items-center justify-between">
                            <div className="block md:flex items-center gap-4">
                                <div className="input_box flex items-center gap-2">
                                    ...
                                    <div className="mt-6">
                                        <button type='button'
                                                className="py-2 px-4 cursor-pointer hover:bg-dark-primary rounded bg-primary text-[14px] text-white">
                                            Search
                                        </button>
                                    </div>
                                </div>
                                <div className="input_box mt-4 md:mt-0 flex items-center gap-2">
                                    <div className="w-full">
                                        <label className="block mb-1 text-[14px] font-medium">
                                            To Date
                                        </label>
                            ...
                            <button onClick={() => setOpenCreateAssetModal(true)}
                                                    ...
                                                    <div
                                                        ...
                                                        {options.map((option, index) => (
                                                            <li
                                                                ...
                                                                className="px-4 py-2 text-[12px] text-black hover:bg-primary hover:text-white cursor-pointer transition-Assets"
                                                            >
                                                                {option}
                                                            </li>
                                                        ))}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">Entry Date</th>
                                    <th className="p-3 border border-gray-200 text-left">Head Name</th>
                                    <th className="p-3 border border-gray-200 text-left">Purpose</th>
                ...
                {OpenCreateAssetModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="absolute inset-0 bg-modal-opacity"
                             onClick={() => setOpenCreateAssetModal(false)}/>
                        <div className="relative bg-white rounded shadow w-2xl mx-4 px-6 py-4 z-10 text-[14px]">
                            ...
                            <h3 className="text-[16px] font-semibold mb-4">Create Liability Rec</h3>
                                ...
                                <form action="" method="">
                                    ...
                                    <div className="mt-4 flex items-center justify-between text-[14px]">
                                        <label className="flex items-center gap-2 cursor-pointer select-none">
                                            ...
                                            <span>Prevent this transaction for Cash In Hand Report!</span>
                                        </label>
                                    </div>
                                </form>
                            </div>
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenCreateAssetModal(false)}
                ...
                {OpenEditAssetModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="absolute inset-0 bg-modal-opacity"
                             onClick={() => setOpenEditAssetModal(false)}/>
                        <div className="relative bg-white rounded shadow w-2xl mx-4 px-6 py-4 z-10 text-[14px]">
                            <button className="absolute top-6 right-6 cursor-pointer text-gray-500 hover:text-red-500"
                                    onClick={() => setOpenEditAssetModal(false)}>
                                <RxCross1 size={18}/>
                            </button>
                            <h3 className="text-[16px] font-semibold mb-4">Edit Liability Rec</h3>
                            <div className="py-4 border-b border-t border-gray-200">
                                <form action="" method="">
                                    <div className="input_box mt-4 block md:flex items-center gap-4">
                                        <div className="w-full">
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenEditAssetModal(false)}
                                        className="px-4 py-2 cursor-pointer rounded bg-red-500 text-white hover:bg-red-700 transition">
                                    Cancel
                                </button>
                                <button onClick={() => setOpenEditAssetModal(false)}
                ...
                {openDeleteAssetModal && (
                    <div
                        ...
                        onClick={() => setOpenDeleteAssetModal(false)}
                    >
                        <div
                        ...
                        >
                            ...
                            <div className="body_text py-4 border-b border-t border-gray-200">
                                <p className="text-gray-500 text-[14px]">
                                    You are going to delete this Liability.<br/>
