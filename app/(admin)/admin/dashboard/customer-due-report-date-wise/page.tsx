                        ...
                        <div className="grid grid-cols-1">
                            <div className="col">
                                <form className="border border-gray-300 rounded p-4">
                                    <div className="input_box block md:flex items-end gap-4">
                                            ...
                                            <div className="block md:flex items-center gap-2">
                                                <div className="relative w-full mt-4 md:mt-0">
                                                    <select
                                                        ...
                                                        <option value="option1">--Select Customer Type--</option>
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full border-collapse">
                                        ...
                                        <tr className="border border-gray-200">
                                            ...
                                            <th className="p-3 border border-gray-200 text-left">Sales Due</th>
                                            <th className="p-3 border border-gray-200 text-left">Hire Due</th>
