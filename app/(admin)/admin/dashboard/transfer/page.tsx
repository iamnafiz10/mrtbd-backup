                    ...
                    <div className="w-full p-6 bg-white rounded border border-gray-200 mt-6 text-[14px]">
                        <div className="block md:flex items-center justify-between">
                            <div className="block md:flex items-center gap-4">
                                <div className="input_box flex items-end gap-2">
                                ...
                                <div className="mt-4 md:mt-0 input_box flex items-end gap-2">
                                    <div className="w-full">
                                        <label className="block mb-1 text-[14px] font-medium">
                                            To Date
                                        </label>
                            ...
                            <div className="flex items-center justify-end">
                                <Link href='/admin/dashboard/transfer/create'
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">Transfer No</th>
                                    <th className="p-3 border border-gray-200 text-left">Transfer Date</th>
                                    <th className="p-3 border border-gray-200 text-left">Total Amount</th>
                                    <th className="p-3 border border-gray-200 text-left">From Concern</th>
                                    <th className="p-3 border border-gray-200 text-left">To Concern</th>
                                    ...
                                    <tr key={item.id} className="border border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 border border-gray-200">
                                            <div className="flex justify-center gap-2">
                                                <Link href='/admin/dashboard/transfer/edit'
                        ...
                        >
                            ...
                            <div className="body_text py-4 border-b border-t border-gray-200">
                                <p className="text-gray-500 text-[14px]">
                                    You are going to delete this Transfer.<br/>
