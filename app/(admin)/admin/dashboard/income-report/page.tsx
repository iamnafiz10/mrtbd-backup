...
function Page() {
    ...
    // -------- ExpensePick Modal ---------- //
    const [openExpensePickModal, setOpenExpensePickModal] = useState(false);
    useEffect(() => {
        if (openExpensePickModal) {
                            ...
                            <div className="col">
                                <form className="border border-gray-300 rounded p-4">
                                    <div className="input_box flex items-center gap-2">
                                        ...
                                        <div className="mt-4">
                                            <div onClick={() => setOpenExpensePickModal(true)}
                ...
                {openExpensePickModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="absolute inset-0 bg-modal-opacity"
                             onClick={() => setOpenExpensePickModal(false)}/>
                        <div
                            ...
                            <div className="flex justify-end gap-3 mt-4 text-[14px]">
                                <button onClick={() => setOpenExpensePickModal(false)}
