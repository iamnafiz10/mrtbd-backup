                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">StockCode</th>
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">IMEI NO</th>
                                    ...
                                    <tr key={item.id} className="border border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 border border-gray-200">
                                            <button
                                                ...
                                                className="bg-gray-800 cursor-pointer py-1 px-4 rounded text-white"
                                            >
                                                Print
                                            </button>
