                ...
                <div className="container">
                    ...
                    <div className="w-full p-6 bg-white rounded border border-gray-200 mt-6 text-[14px]">
                        <div className="flex items-center justify-end">
                            <Link href='/admin/dashboard/sms-bill/create'
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">Paid From Date</th>
                                    <th className="p-3 border border-gray-200 text-left">Paid To Date</th>
