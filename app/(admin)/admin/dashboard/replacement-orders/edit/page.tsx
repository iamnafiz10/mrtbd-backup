...
import {FaCartPlus, FaChevronDown, FaTrashAlt} from "react-icons/fa";
...
function Page() {
    ...
    // ------------- PickDropdownN -----------------//
    const [isOpenPickDropdownN, setIsOpenPickDropdownN] = useState(false);
    const [selectedPickDropdownN, setSelectedPickDropdownN] = useState("");
    const [searchPickDropdownN, setSearchPickDropdownN] = useState("");
    const optionsPickDropdownN = [
        {
            Name: "Product 01",
            Godown: "Test Go",
            Category: "Electronic",
    ...
    const filteredOptionsN = optionsPickDropdownN.filter((item) =>
        item.Name.toLowerCase().includes(searchPickDropdownN.toLowerCase())
    );
    return (
        <>
                                    ...
                                    <div className="input_box mt-4 flex items-center gap-2">
                                        <div className="w-full">
                                            ...
                                            <div className="relative">
                                                {/* Input + Arrow */}
                                                <div
                                                    onClick={() => setIsOpenPickDropdownN(!isOpenPickDropdownN)}
                                                    className="w-full flex items-center justify-between border border-gray-300 rounded px-3 py-2 cursor-pointer focus-within:border-primary"
                                                >
                                                    <input
                                                        type="text"
                                                        value={selectedPickDropdownN}
                                                        readOnly
                                                        placeholder="Select product"
                                                        className="w-full text-[14px] focus:outline-none bg-transparent cursor-pointer"
                                                    />
                                                    ...
                                                    <FaChevronDown
                                                        className={`text-gray-500 text-[12px] transition-transform duration-200 ${
                                                            isOpenPickDropdownN ? "rotate-180" : ""
                                                        }`}
                                                    />
                                                </div>
                                                ...
                                                {isOpenPickDropdownN && (
                                                    <>
                                                        ...
                                                        <div
                                                            className="fixed inset-0 z-10"
                                                            onClick={() => setIsOpenPickDropdownN(false)}
                                                        />
                                                        ...
                                                        <ul className="absolute right-0 mt-2 w-full bg-[#f7f7f7] border border-gray-300 rounded shadow-xl z-20 overflow-hidden">
                                                            ...
                                                            <div className="p-2 border-b border-gray-300">
                                                                <input
                                                                    type="text"
                                                                    placeholder="Search..."
                                                                    value={searchPickDropdownN}
                                                                    onChange={(e) => setSearchPickDropdownN(e.target.value)}
                                                                    className="w-full px-2 py-2 text-[13px] border border-gray-300 rounded focus:outline-none focus:border-primary"
                                                                />
                                                            </div>
                                                            ...
                                                            <div
                                                                className="max-h-32 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600">
                                                                {filteredOptionsN.length > 0 ? (
                                                                    filteredOptionsN.map((option, index) => (
                                                                        <li
                                                                            key={index}
                                                                            onClick={() => {
                                                                                setSelectedPickDropdownN(`${option.Name} (${option.Quantity})`);
                                                                                setIsOpenPickDropdownN(false);
                                                                                setSearchPickDropdownN("");
                                                                            }}
                                                                            className="px-4 py-3 border-b border-gray-200 hover:bg-gray-100 cursor-pointer transition"
                                                                        >
