            ...
            <section id="Product-section" className="mt-10">
                <div className="container">
                    <div
                        ...
                        <h2>Existing BankTransactions</h2>
                    </div>
                    ...
                    <div className="w-full p-6 bg-white rounded border border-gray-200 mt-6 text-[14px]">
                        ...
                        <div className="flex items-center justify-end">
                            <Link href='/admin/dashboard/bank-transaction/create'
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200 text-[12px]">
                                    <th className="p-3 border border-gray-200">
                                        <CustomCheckbox/>
                                    </th>
                                    <th className="p-3 border border-gray-200 text-center">SI</th>
                                    <th className="p-3 border border-gray-200 text-left">TranDate</th>
                                    <th className="p-3 border border-gray-200 text-left">Trans. No</th>
                                    <th className="p-3 border border-gray-200 text-left">Bank Name</th>
                                    <th className="p-3 border border-gray-200 text-left">AccountName</th>
                                    <th className="p-3 border border-gray-200 text-left">Account No</th>
                                    <th className="p-3 border border-gray-200 text-left">Trans. Type</th>
                                    ...
                                    <tr key={item.id} className="border border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 border border-gray-200">
                                            <div className="flex justify-center gap-2">
                                                <Link href='/admin/dashboard/bank-transaction/edit'
                        ...
                        >
                            ...
                            <div className="body_text py-4 border-b border-t border-gray-200">
                                <p className="text-gray-500 text-[14px]">
                                    You are going to delete this Income.<br/>
