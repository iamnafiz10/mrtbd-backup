                ...
                <div className="container">
                    ...
                    <div className="w-full p-6 bg-white rounded border border-gray-200 mt-6 text-[14px]">
                        <div className="flex justify-end">
                            <Link href='/admin/dashboard/menus/create'
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">Parent Menu</th>
                                    <th className="p-3 border border-gray-200 text-left">Description</th>
                                    <th className="p-3 border border-gray-200 text-left">Url</th>
                                    ...
                                    <tr key={item.id} className="border border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 border border-gray-200">
                                            <div className="flex justify-center gap-2">
                                                <Link href='/admin/dashboard/menus/edit'
