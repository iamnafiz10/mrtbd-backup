...
function Page() {
    ...
    return (
        <>
            <section id="supplier-section" className="mt-10">
                <div className="container">
                    ...
                    <div className="w-full p-6 bg-white rounded border border-gray-200 mt-6 text-[14px]">
                        ...
                        <div className="flex justify-end">
                            <Link href='/admin/dashboard/suppliers/create'
                                                    ...
                                                    <div
                                                        ...
                                                        {options.map((option, index) => (
                                                            <li
                                                                ...
                                                                className="px-4 py-2 text-[12px] text-black hover:bg-primary hover:text-white cursor-pointer transition-suppliers"
                                                            >
                                                                {option}
                                                            </li>
                                                        ))}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tr className="border border-gray-200">
                                    ...
                                    <th className="p-3 border border-gray-200 text-left">Supplier Name</th>
                                    <th className="p-3 border border-gray-200 text-left">Owner Contact No.</th>
                                    <th className="p-3 border border-gray-200 text-left">Total Due</th>
                                    <th className="p-3 border border-gray-200 text-left">Owner Name</th>
                                    ...
                                    <tr key={item.id} className="border border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 border border-gray-200">
                                            <div className="flex justify-center gap-2">
                                                <Link href='/admin/dashboard/suppliers/edit'
                        ...
                        >
                            ...
                            <div className="body_text py-4 border-b border-t border-gray-200">
                                <p className="text-gray-500 text-[14px]">
                                    You are going to delete this Supplier.<br/>
